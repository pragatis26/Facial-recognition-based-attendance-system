...
def check_haarcascadefile():
    exists = os.path.isfile(r"C:\Users\Pragati\Downloads\Face_recognition_based_attendance_system-master\Face_recognition_based_attendance_system-master\haarcascade_frontalface_default")
    if not exists:
        mess._show(title='File Missing', message='haarcascade_frontalface_default.xml is missing. Please ensure it is in the correct directory.')
        window.destroy()
...
def TakeImages():
    ...
    if name.isalpha() or ' ' in name:
        ...
        harcascadePath = r"C:\Users\Pragati\Downloads\Face_recognition_based_attendance_system-master\Face_recognition_based_attendance_system-master\haarcascade_frontalface_default"
